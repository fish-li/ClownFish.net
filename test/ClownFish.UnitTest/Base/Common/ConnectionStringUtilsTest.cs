...
public class ConnectionStringUtilsTest
{
    ...
    public void Test()
    {
        ...
        string conn2 = SecurityLogUtils.HideConnectionStringPwd(connectionString);
        ...
        conn2 = SecurityLogUtils.HideConnectionStringPwd(connectionString);
        ...
        Assert.AreEqual(null, SecurityLogUtils.HideConnectionStringPwd(null));
        Assert.AreEqual(string.Empty, SecurityLogUtils.HideConnectionStringPwd(string.Empty));
    }
}
