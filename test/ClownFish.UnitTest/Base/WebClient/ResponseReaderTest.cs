...
<h2>中文汉字</h2>
        ...
        public void Test_ConvertResult()
        {
            ...
            Assert.AreEqual(null, ResponseReader.ConvertResult<Product>("", "xxxxxxx"));

            Product p0 = Product.CreateByFixedData();

            string json = p0.ToJson();
            Product p1 = ResponseReader.ConvertResult<Product>(json, "application/json; charset=utf-8");
            Assert.IsTrue(p0.IsEqual(p1));


            string xml = p0.ToXml();
            Product p2 = ResponseReader.ConvertResult<Product>(xml, "application/xml; charset=utf-8");
