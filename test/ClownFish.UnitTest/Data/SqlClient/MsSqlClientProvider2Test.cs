...
[TestClass]
public class MsSqlClientProvider2Test
{
    [TestMethod]
    public void Test1()
    {
        MsSqlClientProvider2 provider = new MsSqlClientProvider2();

        Assert.AreEqual(DatabaseType.SQLSERVER, provider.DatabaseType);

        Assert.AreSame(Microsoft.Data.SqlClient.SqlClientFactory.Instance, provider.ProviderFactory);
