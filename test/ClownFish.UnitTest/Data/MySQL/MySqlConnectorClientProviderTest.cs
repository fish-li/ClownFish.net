...
[TestClass]
public class MySqlConnectorClientProviderTest
{
    [TestMethod]
    public void Test1()
    {
        MySqlConnectorClientProvider provider = new MySqlConnectorClientProvider();

        Assert.AreEqual(DatabaseType.MySQL, provider.DatabaseType);

        Assert.AreSame(MySqlConnector.MySqlConnectorFactory.Instance, provider.ProviderFactory);
