...
public class DefaultDataLoaderTest : BaseTest
{
    ...
    public void Test_ToSingle_DataRow()
    {
        ...
        string sql = "select * from Customers where CustomerID > 0 limit 1";
    ...
    {
        DefaultDataLoader<Customer> loader = new DefaultDataLoader<Customer>();
        string sql = "select * from Customers order by CustomerID limit 1";
    ...
    {
        DefaultDataLoader<Customer> loader = new DefaultDataLoader<Customer>();
        string sql = "select * from Customers where CustomerID > 0 limit 5";
