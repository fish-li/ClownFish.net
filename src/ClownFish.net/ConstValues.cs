...
public static class ConstValues
{
    ...
    static ConstValues()
    {
        CurrentVersion = AsmHelper.GetFileVersion(typeof(ConstValues)).IfEmpty("8.24.808.2");
    ...
    {
        // 示例：ClownFish.HttpClient/8.24.808.2/TxClientX/cluster1/dev/fish-debian12/Debian GNU-Linux 12 (bookworm)
