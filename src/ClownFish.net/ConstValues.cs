...
public static class ConstValues
{
    ...
    static ConstValues()
    {
        CurrentVersion = AsmHelper.GetFileVersion(typeof(ConstValues)).IfEmpty("8.24.812.1");
    ...
    {
        // 示例：ClownFish.HttpClient/8.24.812.1/TxClientX/cluster1/dev/fish-debian12/Debian GNU-Linux 12 (bookworm)
