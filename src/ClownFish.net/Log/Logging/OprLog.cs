...
public partial class OprLog : IMsgObject, IMsgBeforeWrite
{
    ...
    {
        // 说明：放在这里（时机）做压缩，是允许让其它程序可以有机会借助 LogHelper.RegisterFilter 来实现 “敏感信息过滤”
        // 因为 OprDetails 字段可能会包含敏感信息，需要在写入前过滤掉，一旦压缩之后，就没法识别了。
        // 注意：此方法可能会被多次调用，例如日志对象被 Nebula.LogGate 接收后重新写入。
        this.CompressOprDetails();
    }
}
