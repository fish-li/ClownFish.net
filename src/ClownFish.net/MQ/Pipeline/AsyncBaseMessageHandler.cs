...
public abstract class AsyncBaseMessageHandler<T> : BaseMessageHandlerObject<T> where T : class
{
    /// <summary>
    /// 验证消息的数据是否有效
    /// </summary>
    /// <param name="context"></param>
    public virtual Task ValidateMessage(PipelineContext<T> context)
    {
        // do nothing
    ...
    public virtual Task ProcessMessage(PipelineContext<T> context)
    {
        // do nothing
        return Task.CompletedTask;
    }
    ...
    /// </summary>
    /// <param name="context"></param>
    public virtual Task AfterProcess(PipelineContext<T> context)
    {
        // do nothing
        return Task.CompletedTask;
    }
    ...
    /// </summary>
    /// <param name="context"></param>
    public virtual Task OnEnd(PipelineContext<T> context)
    {
        // do nothing
        return Task.CompletedTask;
    }
    ...
    /// </summary>
    /// <param name="context"></param>
    public virtual Task OnError(PipelineContext<T> context)
    {
        // do nothing
        return Task.CompletedTask;
    }
