...
#if NETFRAMEWORK
    private static ClownFish.Base.WebClient.V1.HttpClient CreateClient(HttpOption option)
    {
        return new ClownFish.Base.WebClient.V1.HttpClient(option);
    }
#else
    private static ClownFish.Base.WebClient.V2.HttpClient2 CreateClient(HttpOption option)
    {
        return new ClownFish.Base.WebClient.V2.HttpClient2(option);
    }
#endif
